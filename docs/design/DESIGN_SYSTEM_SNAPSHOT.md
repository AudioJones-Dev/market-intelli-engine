...
| D-10 | Ratify `adr/0009-mios-adoption-scope.md` — MIOS layers 6 and 7 breach the ADR-0008 domain boundary and are excluded | Operator | Yes, before ACH implementation |
